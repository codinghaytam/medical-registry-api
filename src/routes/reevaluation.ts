...
routes.post("/", uploadSingleImage, async function(req: Request, res: Response, _next: NextFunction){
    try {
...
routes.put("/:id", uploadSingleImage, async function(req: Request, res: Response, _next: NextFunction){
    try {
