 ...
 */
router.post('/:email', async function (req, res, _next) {
    try {
 ...
 */
router.get('/:email/status', async function (req, res, _next) {
    try {
        const { email } = req.params;
        // Validate email parameter
        if (!email) {
 ...
 * Body: { redirectUri?: string, clientId?: string }
 */
router.put('/:email/resend', async function (req, res, _next) {
    try {
        const { email } = req.params;
        const { redirectUri, clientId } = req.body || {};
        // Validate email parameter
 ...
 */
router.put('/:email/mark-verified', validateKeycloakToken, async function (req, res, _next) {
    try {
        const { email } = req.params;
        // Validate email parameter
        if (!email) {
